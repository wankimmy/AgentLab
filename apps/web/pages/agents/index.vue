...
<template>
  <div>
    ...
    <div v-if="agents.length === 0" class="rounded-xl border border-dashed border-[var(--border)] bg-white/60 p-8 text-center">
      <p class="text-[var(--muted)]">No agents yet. Create one to get started.</p>
    </div>
