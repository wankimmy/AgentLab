...
- **Evaluations:** `/evaluations` → create a dataset (or import from template) → **New run** → estimate cost → Quick Check. Results show pass/fail and failure explanations per case.
